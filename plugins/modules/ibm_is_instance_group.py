...
DOCUMENTATION = r'''
---
module: ibm_is_instance_group
short_description: Manage IBM Cloud Instance Group
version_added: "1.0.0"
description:
    - Create, update, or delete IBM Cloud Instance Group
...
class IBMInstanceGroupModule(IBMCloudSDKModule):
    ...
    def get_resource(self, resource_id: str):
        """Get resource by ID."""
        try:
            response = self.vpc_service.get_instance_group(id=resource_id)
...
def main():
    ...
    argument_spec.update({
        ...
        'membership_count': {'type': 'str', 'required': False},
