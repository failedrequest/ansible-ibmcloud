...
DOCUMENTATION = r'''
---
module: ibm_is_reservation
short_description: Manage IBM Cloud Reservation
version_added: "1.0.0"
description:
    - Create, update, or delete IBM Cloud Reservation
...
class IBMReservationModule(IBMCloudSDKModule):
    ...
    def get_resource(self, resource_id: str):
        """Get resource by ID."""
        try:
            response = self.vpc_service.get_reservation(id=resource_id)
    ...
    def create_resource(self):
        ...
        try:
            ...
            'capacity': self.params.get('capacity'),
            'committed_use': self.params.get('committed_use'),
