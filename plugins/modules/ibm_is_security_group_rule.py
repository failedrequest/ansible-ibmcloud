...
class IBMSecurityGroupRuleModule(IBMCloudSDKModule):
    ...
    def list_resources(self):
        ...
        try:
            ...
            self.handle_api_exception(e, "list security_group_rules")

    def create_resource(self):
        """Create a new resource."""
        self.check_mode_exit(changed=True, msg="Would create security_group_rule")
        ...
        try:
            ...
            self.result['msg'] = "security_group_rule created successfully"

        except ApiException as e:
            self.handle_api_exception(e, "create security_group_rule")
    ...
    def run(self):
        ...
        if self.state == 'present':
            ...
            if existing_resource:
                ...
                self.result['msg'] = "security_group_rule not found"
