...
short_description: Manage IBM Cloud Lb Listener
version_added: "1.0.0"
description:
    - Create, update, or delete IBM Cloud Lb Listener
...
RETURN = r'''
resource:
    description: Lb Listener information
    returned: always
    type: dict
changed:
...
class IBMLbListenerModule(IBMCloudSDKModule):
    ...
    def get_resource(self, resource_id: str):
        """Get resource by ID."""
        try:
            response = self.vpc_service.get_load_balancer_listener(id=resource_id)
...
def main():
    ...
    argument_spec.update({
        ...
        'default_pool': {'type': 'str', 'required': False},
