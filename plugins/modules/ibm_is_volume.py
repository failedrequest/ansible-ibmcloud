...
short_description: Manage IBM Cloud Volume
version_added: "1.0.0"
description:
    - Create, update, or delete IBM Cloud Volume
...
class IBMVolumeModule(IBMCloudSDKModule):
    ...
    def get_resource(self, resource_id: str):
        """Get resource by ID."""
        try:
            response = self.vpc_service.get_volume(id=resource_id)
...
def main():
    ...
    argument_spec.update({
        ...
        'capacity': {'type': 'str', 'required': False},
